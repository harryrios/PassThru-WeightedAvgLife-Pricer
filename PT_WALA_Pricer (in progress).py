...
#### NOTE FOR TOMORROW: transpose cashflows
...
from YieldPlotter import yield_plotter, enumerate_month, month_diff
from Yield_to_Price import helper0,helper1,helper2,helper3,YieldToPrice, PriceToYield

def front_spread(back_spread, back_WAL,front_WAL, plus300_cut_percent, WAM, price,
                 front_yield, base_cut_ind, start_month, base_cashflows,
                 start_date, TRSY_mat ):
 ...
 #            self.total_price = (self.FP*self.cut_percent)+(self.BP*(1-self.cut_percent))
...
def main():
    # NOTE: THIS SHOULD BE MOVED INTO ANOTHER FUNCTION 
